...
public class OfferPolicyResource {
    ...
    @Timed
    public ResponseEntity<OfferPolicy> createOfferPolicy(@Valid @RequestBody OfferPolicy offerPolicy) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<OfferPolicy> updateOfferPolicy(@Valid @RequestBody OfferPolicy offerPolicy) throws URISyntaxException {
