...
public interface OfferRepository extends JpaRepository<Offer, Long> {
    ...
    @Query("select offer from Offer offer left join fetch offer.operatingSystems left join fetch offer.countries left join fetch offer.states left join fetch offer.cities left join fetch offer.subCategories left join fetch offer.serviceProviders left join fetch offer.activeDates left join fetch offer.activeDays where offer.id =:id")
