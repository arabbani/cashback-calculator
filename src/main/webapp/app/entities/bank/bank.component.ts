...
export class BankComponent implements OnInit {
    ...
    constructor(private bankService: BankService, private formBuilder: FormBuilder,
        private apsstrDialogService: ApsstrDialogService, private bankTypeService: BankTypeService) {
    ...
    private loadAllBankTypes() {
        this.bankTypeService.findAll().subscribe(
    ...
    private loadAllBank() {
        this.bankService.findWithType().subscribe(
