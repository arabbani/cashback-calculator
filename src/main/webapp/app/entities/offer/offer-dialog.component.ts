...
export class OfferDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.reechargePlanTypeService.query()
            .subscribe((res: HttpResponse<ReechargePlanType[]>) => { this.reechargeplantypes = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    ...
    trackReechargePlanTypeById(index: number, item: ReechargePlanType) {
        return item.id;
    }
