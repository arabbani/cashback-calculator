...
public class CircleResourceIntTest {
    ...
    public void createCircle() throws Exception {
        ...
        assertThat(testCircle.getCode()).isEqualTo(DEFAULT_CODE);
    }
    ...
    public void updateCircle() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCircle are not directly saved in db
        em.detach(updatedCircle);
        updatedCircle
            .name(UPDATED_NAME)
            .code(UPDATED_CODE);
        ...
        assertThat(testCircle.getCode()).isEqualTo(UPDATED_CODE);
    }
