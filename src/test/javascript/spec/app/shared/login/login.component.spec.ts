...
import { ApsstrLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: ApsstrLoginModalComponent;
        let fixture: ComponentFixture<ApsstrLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ApsstrLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(ApsstrLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(ApsstrLoginModalComponent);
