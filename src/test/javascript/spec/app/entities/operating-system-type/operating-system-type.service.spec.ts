...
describe('Service Tests', () => {
    ...
    describe('OperatingSystemType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OperatingSystemTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/operating-system-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OperatingSystemType', () => {
