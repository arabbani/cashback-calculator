...
import { ServiceProviderDialogComponent } from '../../../../../../main/webapp/app/entities/service-provider/service-provider-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('ServiceProvider Management Dialog Component', () => {
        let comp: ServiceProviderDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ServiceProviderDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'serviceProviderListModification', content: 'OK'});
