...
describe('Service Tests', () => {
    ...
    describe('AffiliateCredential Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AffiliateCredentialService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/affiliate-credentials';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AffiliateCredential', () => {
